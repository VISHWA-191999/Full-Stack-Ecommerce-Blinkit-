...
const CategoryWiseProductDisplay = ({ id, name }) => {
    ...
    const fetchCategoryWiseProduct = async () => {
        try {
            console.log("inside fetchCategoryWiseProduct function")
            setLoading(true)
            ...
            console.log("response categoryWise",response)
    ...
    return (
        <div>
            ...
            <div className='relative flex items-center '>
                <div className=' flex gap-4 md:gap-6 lg:gap-8 container mx-auto px-4 overflow-hidden  scroll-smooth' ref={containerRef}>
                    {loading &&
